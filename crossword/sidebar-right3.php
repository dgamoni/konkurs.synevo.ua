<!-- sidebar right only for main crossword script -->
	<div id="secondary-right">
	   ...
	   $sword = get_user_meta( $user_id_sinevo, 'sword3', true );
	   //var_dump($sword[1]);
	   ...
	   for ($j = 0; $j <= 20; $j++) {
		    $pos = 0;
	   		$pos = get_user_meta( $user_id_sinevo, 'pos3_'.$j , true );
       ...
       <div id="printcross">
	   <a href="<?php bloginfo('template_url'); ?>/img/Synevo__Crossword__Website__Print_version__0203.pdf" target="_blank">Версия для печати</a>
       </div>
