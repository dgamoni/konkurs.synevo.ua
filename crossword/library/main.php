...
class acf_time_picker extends acf_Field
{
	...
	*-------------------------------------------------------------------------------------*/
	...
	function admin_print_scripts()
	{
		...
		wp_enqueue_script('jquery-ui-timepicker', get_stylesheet_directory_uri() . '/library/js/jquery-ui-timepicker-addon.js',array(
			'jquery-ui-datepicker',
			'jquery-ui-slider'
		),'1.0.0', true ); 	
		wp_enqueue_script('timepicker', get_stylesheet_directory_uri() . '/library/js/timepicker.js',array(
	...
	{
		wp_enqueue_style('jquery-style', get_stylesheet_directory_uri() . '/library/css/jquery-ui.css'); 
		wp_enqueue_style('timepicker',  get_stylesheet_directory_uri() . '/library/css/jquery-ui-timepicker-addon.css',array(
			'jquery-style'
		),'1.0.0');
	}
