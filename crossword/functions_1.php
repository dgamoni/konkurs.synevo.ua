...
//-----------------------------------
function affiplus_getreferral_1()
{
	global $wpdb;
...
add_action("init", "affiplus_getreferral_1");

/* !!!! --------  affplus plugin paste ----------------------------!!!! */
function affiplus_register1($userid)
{
	global $wpdb;
...
//add_action("user_register", "affiplus_register1"); 
add_action("register_form", "affiplus_register1"); 
/* !!!! --------  affplus plugin paste ----------------------------!!!! */