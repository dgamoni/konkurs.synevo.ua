<!-- sidebar right only for main crossword script -->
	<div id="secondary-right">
	   ...
	   $sword = get_user_meta( $user_id_sinevo, 'sword2', true );
	   //var_dump($sword[1]);
	   ...
	   for ($j = 0; $j <= 20; $j++) {
		    $pos = 0;
	   		$pos = get_user_meta( $user_id_sinevo, 'pos2_'.$j , true );
       ...
       <div id="word-wrapper">
            ...
            <div id="word-descript">
                ...
                <p class="prompt">За повторное разгадывание баллы не начисляются</p>
				 ...
				 jQuery(document).ready(function($){ 
						...
						var data = {
						action: 'my_action',
						check2: check2,      // We pass php values differently!
 	   ...
 	   <div id="printcross">
	   <a href="<?php bloginfo('template_url'); ?>/img/Synevo__Crossword__Website__Print_version__0202.pdf" target="_blank">Версия для печати</a>
       </div>
