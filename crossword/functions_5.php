...
foreach ($blogusers as $user) {
	...
	if($i <= 10)
	{
	echo '<li class="cmp3_li" ><span class="cmp3_span1 cent">' . $i . '</span><span class="cmp3_span2">' . $user->display_name . ' ' . $user->nickname . '</span><span class="cmp3_span1 cent">' . get_user_meta($user->ID, 'all_rating', true). '</span></li>';
