...
// dgamoni edit !!!  del  clues standart ------------------------------------------------------------
				...
				*/
				...
				if((activePosition ==3) ){$('.entry-21 input:first').val(mycurrVal[6]); sword2[0]=mycurrVal[6];} //a
...
//------------- заполняем автоматически контрольное слово-----------------
				if((activePosition ==3) ){$('.entry-21 input:first').val(mycurrVal[6]).addClass('done'); sword2[0]=mycurrVal[6].toUpperCase();} //a
