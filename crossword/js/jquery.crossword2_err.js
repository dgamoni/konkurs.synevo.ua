...
// dgamoni edit !!!  del  clues standart ------------------------------------------------------------
				...
				*/
				buildEntries: function() {
					...
					for (var i=1, p = entryCount; i-1 < p; ++i) {
						...
						if(i==14) {$groupedLights.eq(1).append('<span class="myindex">14</span>');}
					}	
				...
				*/
				...
				if((activePosition ==3) ){$('.entry-21 input:first').val(mycurrVal[5]); sword2[0]=mycurrVal[5];} //a
				if((activePosition ==5)){ $('.entry-21 input:eq(1)').val(mycurrVal[2]); sword2[1]=mycurrVal[2];} //c 
				if((activePosition ==4)){ $('.entry-21 input:eq(2)').val(mycurrVal[7]); sword2[2]=mycurrVal[7];
										  $('.entry-21 input:eq(4)').val(mycurrVal[14]); sword2[4]=mycurrVal[14];} //к p
				if((activePosition ==15)){ $('.entry-21 input:eq(3)').val(mycurrVal[3]); sword2[3]=mycurrVal[3];} //a
				if((activePosition ==17)){ $('.entry-21 input:eq(5)').val(mycurrVal[5]); sword2[5]=mycurrVal[5];}//и
				if((activePosition ==0)){ $('.entry-21 input:eq(6)').val(mycurrVal[3]); sword2[6]=mycurrVal[3];} //д
				if((activePosition ==2)){ $('.entry-21 input:eq(6)').val(mycurrVal[0]); sword2[6]=mycurrVal[0];}//д
				if((activePosition ==8)){ $('.entry-21 input:eq(7)').val(mycurrVal[4]); sword2[7]=mycurrVal[4];} //o
				if((activePosition ==13)){ $('.entry-21 input:eq(8)').val(mycurrVal[8]); sword2[8]=mycurrVal[8];} //з
				
				console.log(sword2[0]+sword2[1]+sword2[2]+sword2[3]+sword2[4]+sword2[5]+sword2[6]+sword2[7]+sword2[8]+sword2[9]);
				console.log(sword2);
				
				if (( activePosition != 1) && ( activePosition != 6) && ( activePosition != 7) && ( activePosition != 9)  && ( activePosition != 10)  && ( activePosition != 11)  && ( activePosition != 12)  && ( activePosition != 14) && ( activePosition != 16) && ( activePosition != 18) && ( activePosition != 19) )
				{//alert(sword);
				//------------- ajax  -----------------------------------			
				var data = {
						action: 'my_action',
						sword2: sword2      // We pass php values differently!
						//vall: vall
							};
...
//------------- ajax  -----------------------------------			
				var data = {
						action: 'my_action',
						pos2: pos2,      // We pass php values differently!
						vall2: vall2
							};
				// We can also pass the url value separately from ajaxurl for front end AJAX implementations
				jQuery.post(
...
//------------- заполняем автоматически контрольное слово-----------------
				if((activePosition ==3) ){$('.entry-21 input:first').val(mycurrVal[5]).addClass('done'); sword2[0]=mycurrVal[5].toUpperCase();} //a
				if((activePosition ==5)){ $('.entry-21 input:eq(1)').val(mycurrVal[2]).addClass('done'); sword2[1]=mycurrVal[2].toUpperCase();} //c 
				if((activePosition ==4)){ $('.entry-21 input:eq(2)').val(mycurrVal[7]).addClass('done'); sword2[2]=mycurrVal[7].toUpperCase();
										  $('.entry-21 input:eq(4)').val(mycurrVal[14]).addClass('done'); sword2[4]=mycurrVal[14].toUpperCase();} //к p
				if((activePosition ==15)){ $('.entry-21 input:eq(3)').val(mycurrVal[3]).addClass('done'); sword2[3]=mycurrVal[3].toUpperCase();} //a
				if((activePosition ==17)){ $('.entry-21 input:eq(5)').val(mycurrVal[5]).addClass('done'); sword2[5]=mycurrVal[5].toUpperCase();}//и
				if((activePosition ==0)){ $('.entry-21 input:eq(6)').val(mycurrVal[3]).addClass('done'); sword2[6]=mycurrVal[3].toUpperCase();} //д
				if((activePosition ==2)){ $('.entry-21 input:eq(6)').val(mycurrVal[0]).addClass('done'); sword2[6]=mycurrVal[0].toUpperCase();}//д
				if((activePosition ==8)){ $('.entry-21 input:eq(7)').val(mycurrVal[4]).addClass('done'); sword2[7]=mycurrVal[4].toUpperCase();} //o
				if((activePosition ==13)){ $('.entry-21 input:eq(8)').val(mycurrVal[8]).addClass('done'); sword2[8]=mycurrVal[8].toUpperCase();} //з
